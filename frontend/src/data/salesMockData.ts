...
export const MOCK_SALES: Sale[] = [
  ...
  { saleId: "SL-002", customerId: "cus-002", customerName: "Ama Boateng", employmentId: "emp-101", soldBy: "Ama Serwaa", saleDate: "2026-08-11", total: 580, itemCount: 1, saleStatus: "UNPAID" },
  ...
  { saleId: "SL-004", customerId: "cus-004", customerName: "Abena Frimpong", employmentId: "emp-100", soldBy: "Samuel Adjei", saleDate: "2026-08-10", total: 840, itemCount: 2, saleStatus: "PARTIALLY_PAID" },
...
export const SALES_STATS: StatCardData[] = [
  ...
  { id: "pending", title: "Unpaid Orders", value: 1, trend: "neutral", subtitle: "Awaiting payment", icon: faClock, accentColor: "amber" },
  { id: "overdue", title: "Partially Paid Orders", value: 1, trend: "down", subtitle: "Requires follow-up", icon: faTriangleExclamation, accentColor: "rose" },
];
